/*
  ...
  Provides a web based interface to control a remote control car over WiFi.
...
// Define motor pins for CAP10 Pratham
int M1A = 25;
int M1B = 33;
int M2A = 27;
int M2B = 26;
...
void movebot() {
   ...
   * Check for the movement key received in argument
